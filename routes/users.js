...
router.get("/", CheckLogin,CheckRole("ADMIN", "Quản trị viên"), async function (req, res, next) {
  let users = await userController.GetAllUser()
  res.send(users);
});

router.get("/:id", CheckLogin,CheckRole("ADMIN","Quản trị viên"), async function (req, res, next) {
  try {
...
let newItem = await userController.CreateAnUser(
      ...
      undefined, // <--- Add this to skip the session parameter
